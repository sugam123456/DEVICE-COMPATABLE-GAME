...
path=createSprite(windowWidth-windowHight);
...
function createCash() {
  if (World.frameCount % 200 == 0) {
   ...
   var cash =createSprite(windowHight-windowWidth);
  cash.scale=0.12;
  cash.velocityY = 5;
  cash.lifetime = 200;
  cashG.add(cash);
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(windowWidth-windowHight);
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(windowWidth-windowHight);
...
// Modify the positions of sword to make them spawn throughout the available screen size.
    ...
    var sword = createSprite(windowWidth-windowHight);
